...
w.df2 <- fread(analysis.dir %&% "coexpress-enrich_weighted_p10Coding_with-shared.txt") %>% 
  na.omit(.)
...
plt4 <- plot_enrich(sub.df2,nrow1=TRUE)
ggsave(plot=plt4,filename = plot.dir %&% "coexpress-enrich_weighted-noCoding-fourtiss_with-shared.png",width=8,height=4)
ggsave(plot=plt4,filename = plot.dir %&% "coexpress-enrich_weighted-noCoding-fourtiss_with-shared.pdf",width=8,height=4)
