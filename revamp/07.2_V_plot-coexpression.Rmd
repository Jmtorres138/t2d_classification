...
plot_enrich_alt <- function(plot.df,nrow1=FALSE){
  ...
  plt <- plt + scale_shape_manual(name="Gene set",values=c(21,22,23,24)) +
    ...
    scale_size(range=c(0.1,10),limits=c(0,250))# + 
    #coord_flip() + 
    #theme_bw()
  return(plt)
}
...
ggsave(plot=plt4,filename = plot.dir %&% "coexpress-enrich_weighted-noCoding-fourtiss_with-shared.png",width=15,height=7)
