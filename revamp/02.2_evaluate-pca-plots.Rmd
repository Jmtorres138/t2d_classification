...
pA <- complete_pca(filter(weighted.df,
  Locus.ID %in% keep.vec),centerScale=FALSE)
##pca.list.unweighted.pruned <-  make_pca_inputs(filter(weighted.df,
##  Locus.ID %in% keep.vec),centerScale=FALSE) 
##pB <- complete_pca(filter(weighted.df,
##  Locus.ID %in% keep.vec),centerScale=FALSE)
# Manual save 
# Save dimensions W=1300,H=600 
# pca_weigthed_maxppa50.png
# pca_unweigthed_maxppa50.png
...
##pca.list.unweighted.pruned <-  make_pca_inputs(filter(unweighted.df,
##  Locus.ID %in% keep.vec, other<=0.10),centerScale=FALSE) 
##pB <- complete_pca(filter(unweighted.df,
##  Locus.ID %in% keep.vec, other<=0.10),centerScale=FALSE)
# Manual save 
# Save dimensions W=1300,H=600 
# pca_weigthed_maxppa50-other10.png
# pca_unweigthed_maxppa50-other10.png
...
##pruneA.plt <- pca_plot_annotated(pca.list.unweighted.pruned[[1]],
##                   pca.list.unweighted.pruned[[2]],"PC1","PC2")
##pruneB.plt <- pca_plot_annotated(pca.list.unweighted.pruned[[1]],
##                   pca.list.unweighted.pruned[[2]],"PC2","PC3")
##ggsave(plot=pruneA.plt,
##       filename=plot.dir%&%"pca_unweigthed_maxppa50-other10-pc1-pc2.png",
##       height=6,width=6)
##ggsave(plot=pruneB.plt,
##       filename=plot.dir%&%"pca_unweigthed_maxppa50-other10-pc2-pc3.png",
##       height=6,width=6)
