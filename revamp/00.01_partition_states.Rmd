...
write.dir <- work.dir %&% "analysis_files/partitioned/"
...
write.table(bed.df,file=write.dir%&%"complete_isl-adi-mus-liv.partitioned.bed",quote=F,sep="\t",row.names=F,col.names=F)
