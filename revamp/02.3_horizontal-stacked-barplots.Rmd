...
all_tissues_plot <- function(ppa.df,number=NULL,col.vec=c("olivedrab2","red","gold1","brown","grey")){
  ...
  plt5 <- ppa_plot(ppa.df,col.vec,rankby="Unclassified",number,leg=TRUE)  
...
ggsave(plot=grob1,filename=plot.dir%&%"stacked_barplots_full-weighted.png",width=25,height=8.5)
ggsave(plot=grob1,filename=plot.dir%&%"stacked_barplots_full-weighted.pdf",width=25,height=8.5)
...
#3ggsave(plot=grob6,filename=plot.dir%&%"stacked_barplots_maxppa50-unweighted.png",width=27,height=12)
