...
ggsave(file = plot.dir %&% "tiss_het_19_same.png", arrangeGrob(grobs = plot.list, ncol = 10),
       width=21,height=5) 
ggsave(file = plot.dir %&% "tiss_het_19_same.pdf", arrangeGrob(grobs = plot.list, ncol = 10),
       width=21,height=5) 
...
filter(df,loc %in% loc.vec) %>% dim(.) # 126 signals at these 40 loci 
