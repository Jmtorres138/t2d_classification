...
names(tab1.df) <- c("Signal \n(i.e. lead SNP rsid","Gene Symbol", "Number of SNPs\nin 99% credible set",
                    "Maximum credible set PPA", "Coding Score",
                    "Dissimilarity\n(difference between top two TOA scores",
...
write.table(x=tab1.df,file="SuppTable_shared_tier1.csv",quote=F,sep=",",row.names=F)
...
names(tab2.df) <- c("Signal \n(i.e. lead SNP rsid","Gene Symbol", "Number of SNPs\nin 99% credible set",
                    "Maximum credible set PPA", "Coding Score",
                    "Dissimilarity\n(difference between top two TOA scores",
                    "Sum of squared TOA score differences (SSD)",
                    "Islet TOA score","Muscle TOA score","Adipose TOA score","Liver TOA score",
                    "Unclassified TOA score")
write.table(x=tab2.df,file="SuppTable_shared_tier2.csv",quote=F,sep=",",row.names=F)
...
names(tab3.df) <- c("Signal \n(i.e. lead SNP rsid","Gene Symbol", "Number of SNPs\nin 99% credible set",
                    "Maximum credible set PPA", "Coding Score",
                    "Dissimilarity\n(difference between top two TOA scores",
                    "Sum of squared TOA score differences (SSD)",
                    "Islet TOA score","Muscle TOA score","Adipose TOA score","Liver TOA score",
                    "Unclassified TOA score")
write.table(x=tab3.df,file="SuppTable_shared_tier3.csv",quote=F,sep=",",row.names=F)
