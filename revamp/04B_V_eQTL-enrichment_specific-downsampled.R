...
input2.df <- fread(proj.dir %&% "revamp/analysis_files/classified-loci_weighted_with-shared.txt")
thresh2.df <- evaluate_thresholds(input2.df,iter=1000)
write.table(x=thresh2.df,file=proj.dir%&%"revamp/analysis_files/downsampled_eqtl-specific-validation_weighted-seed2_with-shared.txt",
