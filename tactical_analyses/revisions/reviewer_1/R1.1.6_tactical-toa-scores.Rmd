...
gen.df <- fread(proj.dir %&% "tactical_analyses/genetic_credible_sets/gencred.txt") %>% 
...
write.table(x=tscores.df,file=file.dir%&%"toa-scores-with-visc.txt",quote=F,sep="\t",row.names=F)
...
write.table(class.df,file.dir%&%"classified-loci_weighted_with-shared-adiVisc.txt",sep="\t",quote=F,row.names=F)
