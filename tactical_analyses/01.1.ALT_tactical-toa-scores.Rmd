...
snp.df <- annotate_snps(snp_file = input.dir%&%"credible-input.txt", 
                        ...
                        tissue_annotation_file = input.dir%&%"tissue-annotations_alt.txt", 
                        genomic_path_file = input.dir%&%"genomic-file-paths.txt",
                        genomic_annotation_file = input.dir%&%"genomic-annotations_alt.txt")
```
...
write.table(class.df,file.dir%&%"classified-loci_weighted_with-shared_ALT.txt",sep="\t",quote=F,row.names=F)
...
write.table(class.df,file.dir%&%"classified-loci_weighted_ALT.txt",sep="\t",quote=F,row.names=F)
