...
ggsave(plot=plt.list1[[1]],filename=plot.dir%&%"finemap_wilcox-compare-max_weighted_with-shared_set101.png",height=3.5,width=4)
...
eval.df <- plt.list1[[3]]
sub <- filter(eval.df,threshold==0.2,group=="islet")
...
ggsave(plot=plt1,filename=plot.dir%&%"finemap_wilcox-compare-max_weightedV2_with-shared_set101.png",height=3,width=8)  
ggsave(plot=plt1,filename=plot.dir%&%"finemap_wilcox-compare-max_weightedV2_with-shared_set101.pdf",height=3,width=8)    
```


```{r}

write.table(x=plt.df,file=work.dir%&%"analysis_files/finemap-enrich_with-shared_set101.txt",sep="\t",quote=F,row.names=F)
