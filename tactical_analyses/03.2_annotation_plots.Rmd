...
#annotall.df$strong_enhancer.Liver <- annotall.df$`10_Active_enhancer_2.Liver` +
#  annotall.df$`9_Active_enhancer_1.Liver`
#annotall.df$strong_enhancer.Muscle <- annotall.df$`10_Active_enhancer_2.Muscle` +
#  annotall.df$`9_Active_enhancer_1.Muscle`
#annotall.df$strong_enhancer.Adipose <- annotall.df$`10_Active_enhancer_2.Adipose` +
#  annotall.df$`9_Active_enhancer_1.Adipose`
#annotall.df$strong_enhancer.Islet <- annotall.df$`10_Active_enhancer_2.Islet` +
#  annotall.df$`9_Active_enhancer_1.Islet`
