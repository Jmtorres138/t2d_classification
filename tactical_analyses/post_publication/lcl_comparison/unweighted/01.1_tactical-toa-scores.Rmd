...
tvec.df <- calculate_tissue_vectors(snp.annotated.df = snp.df,
                                    ...
                                    genomic_annotation_file = input.dir%&%"genomic-annotations.txt",
                                    ess.annot = "coding",
                                    ess.file = input.dir%&%"gene-expression-specificity-scores_v1.txt")
```
...
names(class.df)[1:6] <- c("Locus.ID","adipose","islet","lcl","liver","muscle")
...
write.table(class.df,file.dir%&%"classified-loci_unweighted_with-shared.txt",sep="\t",quote=F,row.names=F)
...
write.table(class.df,file.dir%&%"classified-loci_unweighted.txt",sep="\t",quote=F,row.names=F)
