...
write.table(x=df71,file = write.dir %&% "analysis_files/" %&% 
              "phys71-enrich_weighted_with-shared.txt",
            sep="\t",quote=F,row.names=F)
...
write.table(x=df82b,file = write.dir %&% "analysis_files/" %&% 
              "phys-enrich82_weighted-V2.txt",sep="\t",quote=F,row.names=F)
...
write.table(x=df73b,file = write.dir %&% "analysis_files/" %&% 
              "phys-enrich73_weighted-V2.txt",sep="\t",quote=F,row.names=F)
...
write.table(x=df53b,file = write.dir %&% "analysis_files/" %&% 
              "phys-enrich53_weighted-V2.txt",sep="\t",quote=F,row.names=F)
...
write.table(x=df71b,file = write.dir %&% "analysis_files/" %&% 
              "phys-enrich71_weighted-V2.txt",sep="\t",quote=F,row.names=F)
