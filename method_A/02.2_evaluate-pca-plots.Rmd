...
plt <- complete_pca(full.df,centerScale=FALSE)
...
pca.list.full.pruned <- make_pca_inputs(filter(full.df,other<=0.1),
                                 centerScale=FALSE)  
pca.list.wfull.pruned <- make_pca_inputs(filter(wfull.df,other<=0.1),
                                 centerScale=FALSE)  
pca.list.reduced.pruned <- make_pca_inputs(filter(cse.df,other<=0.1),
                                    centerScale=FALSE) 

complete_pca(filter(full.df,other<=0.1),centerScale=FALSE)
complete_pca(filter(wfull.df,other<=0.1),centerScale=FALSE)
complete_pca(filter(cse.df,other<=0.10),centerScale=FALSE)


prune1.plt <- pca_plot_annotated(pca.list.full.pruned[[1]],
                   pca.list.full.pruned[[2]],"PC1","PC2")


prune2.plt <- pca_plot_annotated(pca.list.reduced.pruned[[1]],
                   pca.list.reduced.pruned[[2]],"PC1","PC2")
...
pruneA.plt <- pca_plot_annotated(pca.list.full.pruned[[1]],
                   pca.list.full.pruned[[2]],"PC1","PC2")
pruneB.plt <- pca_plot_annotated(pca.list.full.pruned[[1]],
                   pca.list.full.pruned[[2]],"PC2","PC3")

ggsave(plot=pruneA.plt,filename=plot.dir%&%"pca_pruned-full-pc1-pc2.pdf",height=6,width=6)
ggsave(plot=pruneB.plt,filename=plot.dir%&%"pca_pruned-full-pc2-pc3.pdf",height=6,width=6)
...
pruneA.plt <- pca_plot_annotated(pca.list.wfull.pruned[[1]],
                   pca.list.wfull.pruned[[2]],"PC1","PC2")
pruneB.plt <- pca_plot_annotated(pca.list.wfull.pruned[[1]],
                   pca.list.wfull.pruned[[2]],"PC2","PC3")

ggsave(plot=pruneA.plt,filename=plot.dir%&%"pca_pruned-full-weighted-pc1-pc2.pdf",height=6,width=6)
ggsave(plot=pruneB.plt,filename=plot.dir%&%"pca_pruned-full-weighted-pc2-pc3.pdf",height=6,width=6)
...
pruneA.plt <- pca_plot_annotated(pca.list.reduced.pruned[[1]],
                   pca.list.reduced.pruned[[2]],"PC1","PC2")
pruneB.plt <- pca_plot_annotated(pca.list.reduced.pruned[[1]],
                   pca.list.reduced.pruned[[2]],"PC2","PC3")

ggsave(plot=pruneA.plt,filename=plot.dir%&%"pca_pruned-reduced-pc1-pc2.pdf",height=6,width=6)
ggsave(plot=pruneB.plt,filename=plot.dir%&%"pca_pruned-reduced-pc2-pc3.pdf",height=6,width=6)
