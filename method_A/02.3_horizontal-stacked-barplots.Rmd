...
grob1 <- all_tissues_plot(scale.df,number=50)
ggsave(plot=grob1,filename=plot.dir%&%"stacked_barplots_full-weighted-LocusScaled.pdf",width=25,height=15)

grob2 <- all_tissues_plot(unscale.df,number=50)
ggsave(plot=grob2,filename=plot.dir%&%"stacked_barplots_full-weighted-unscaled.pdf",width=25,height=15)
