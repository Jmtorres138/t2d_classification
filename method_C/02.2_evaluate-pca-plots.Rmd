...
pca.list.alt <- make_pca_inputs(alt.df,centerScale=FALSE) 
...
plt.alt <- complete_pca(alt.df,centerScale=FALSE)
...
pca.list.weighted.pruned <- make_pca_inputs(filter(weighted.df,other<=0.1),
                                 centerScale=FALSE)  
complete_pca(filter(weighted.df,other<=0.1),centerScale=FALSE)


pca.list.unweighted.pruned <- make_pca_inputs(filter(unweighted.df,other<=0.1),
                                 centerScale=FALSE)  
complete_pca(filter(unweighted.df,other<=0.1),centerScale=FALSE)


pca.list.alt.pruned <- make_pca_inputs(filter(alt.df,other<=0.1),
                                 centerScale=FALSE)  
complete_pca(filter(alt.df,other<=0.1),centerScale=FALSE)
...
ggsave(plot=pruneA.plt,filename=plot.dir%&%"pca_pruned-full-weighted-pc1-pc2.png",
       height=6,width=6)
ggsave(plot=pruneB.plt,filename=plot.dir%&%"pca_pruned-full-weighted-pc2-pc3.png",
       height=6,width=6)
...
pruneA.plt.un <- pca_plot_annotated(pca.list.unweighted.pruned[[1]],
                   pca.list.unweighted.pruned[[2]],"PC1","PC2")
pruneB.plt.un <- pca_plot_annotated(pca.list.unweighted.pruned[[1]],
                   pca.list.unweighted.pruned[[2]],"PC2","PC3")
ggsave(plot=pruneA.plt.un,filename=plot.dir%&%
         "pca_pruned-full-unweighted-pc1-pc2.png",height=6,width=6)
ggsave(plot=pruneB.plt.un,filename=plot.dir%&%
         "pca_pruned-full-unweighted-pc2-pc3.png",height=6,width=6)
...
pruneA.plt.alt <- pca_plot_annotated(pca.list.alt.pruned[[1]],
                   pca.list.alt.pruned[[2]],"PC1","PC2")
pruneB.plt.alt <- pca_plot_annotated(pca.list.alt.pruned[[1]],
                   pca.list.alt.pruned[[2]],"PC2","PC3")
ggsave(plot=pruneA.plt.alt,filename=plot.dir%&%
         "pca_pruned-full-alternative-pc1-pc2.png",height=6,width=6)
ggsave(plot=pruneB.plt.alt,filename=plot.dir%&%
         "pca_pruned-full-alternative-pc2-pc3.png",height=6,width=6)
